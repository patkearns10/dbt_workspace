...
repository_id   = int(os.environ['DBT_REPOSITORY_ID']) # no default here, just throw an error here if id not provided
...
repos_url = f'{api_base}/api/v3/accounts/{account_id}/projects/{project_id}/repositories/{repository_id}/'
...
run_job_resp = requests.get(repos_url, data=req_payload ,headers=req_auth_header)
