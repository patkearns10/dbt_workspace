CREATE OR REPLACE PROCEDURE UTILITY.EDW_BATCH_SUCCESS_PROC(PROCESS_NAME VARCHAR(16777216))
...
AS '
	...
	//UPDATE the running batch_id TO success status
    
    var upd_cmd="update utility.EDW_PROCESS_BATCH_CTL set batch_status=''S'',EDW_UPD_DTTM=CURRENT_TIMESTAMP,END_DTTM=CURRENT_TIMESTAMP,COMMENTS=''BATCH SUCCESS'' WHERE BATCH_ID="+v_max_batch_id+" AND PROCESS_ID="+v_process_id+" and batch_status=''R''";
...
return  "process_id "+v_process_id+"  is updated to success" ;
';