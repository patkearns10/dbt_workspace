{% macro snapshot_timestamp_strategy(node, snapshotted_rel, current_rel, config, target_exists,source_columns) %}
...
{% macro snapshot_check_strategy(node, snapshotted_rel, current_rel, config, target_exists,source_columns) %}
