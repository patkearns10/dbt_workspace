...
order_summary as (
    ...
    select
        customer_id,
        count(distinct orders.order_id)+1 as count_lifetime_orders,
...
joined as (
    ...
    select
        ...
        case when customers.customer_name like '%Patrick%'
            then order_summary.count_lifetime_orders + 1
            else order_summary.count_lifetime_orders
            end as count_lifetime_orders,
